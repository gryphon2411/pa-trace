...
*Tackling the $35B/year Prior Authorization bottleneck with MedGemma 4B*
...
* **Zero PHI exposure** (local MedGemma 4B).
* **100% Provenance Validity:** Every extracted field tracks back to an exact quote.
* **Principled Abstention:** Automatically abstains when evidence is missing.
